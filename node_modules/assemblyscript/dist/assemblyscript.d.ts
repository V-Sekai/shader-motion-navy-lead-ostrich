...
declare module "assemblyscript/src/util/terminal" {
    /**
...
declare module "assemblyscript/src/util/index" {
    ...
    export * from "assemblyscript/src/util/terminal";
...
declare module "assemblyscript/src/types" {
    ...
    import { TypeRef } from "assemblyscript/src/module";
...
declare module "assemblyscript/src/passes/pass" {
    /**
     * @fileoverview Infrastructure for custom Binaryen passes.
     * @license Apache-2.0
     */
    import { Module, ExpressionRef, FunctionRef, GlobalRef, Index, StringRef } from "assemblyscript/src/module";
...
declare module "assemblyscript/src/passes/findusedlocals" {
    /**
...
declare module "assemblyscript/src/flow" {
    ...
    export { findUsedLocals } from "assemblyscript/src/passes/findusedlocals";
}
...
declare module "assemblyscript/src/passes/rtrace" {
    /**
     ...
     * @license Apache-2.0
     */
    import { Pass } from "assemblyscript/src/passes/pass";
    import { Compiler } from "assemblyscript/src/compiler";
    import { ExpressionRef, TypeRef } from "assemblyscript/src/module";
...
declare module "assemblyscript/src/passes/shadowstack" {
    /**
     ...
     */
    import { Pass } from "assemblyscript/src/passes/pass";
    import { ExpressionRef, FunctionRef, Index, BinaryOp, TypeRef, ExportRef } from "assemblyscript/src/module";
    import { Compiler, Options } from "assemblyscript/src/compiler";
...
declare module "assemblyscript/src/compiler" {
     ...
     */
    import { DiagnosticEmitter } from "assemblyscript/src/diagnostics";
    import { Module, MemorySegment, ExpressionRef, TypeRef, GlobalRef } from "assemblyscript/src/module";
    ...
    import { Type, Signature } from "assemblyscript/src/types";
    import { ShadowStackPass } from "assemblyscript/src/passes/shadowstack";
    /** Compiler options. */
...
declare module "assemblyscript/src/module" {
    ...
    import * as binaryen from "assemblyscript/src/glue/binaryen";
    ...
    export namespace TypeRef {
        ...
        const F64: TypeRef;
        const V128: TypeRef;
        const Funcref: TypeRef;
        const Externref: TypeRef;
        const Anyref: TypeRef;
        const Eqref: TypeRef;
        const I31ref: TypeRef;
        const Dataref: TypeRef;
        const Auto: TypeRef;
    }
    ...
    export class Module {
        ...
        call_indirect(index: ExpressionRef, operands: ExpressionRef[] | null, params: TypeRef, results: TypeRef, isReturn?: boolean): ExpressionRef;
        return_call_indirect(tableName: string, index: ExpressionRef, operands: ExpressionRef[] | null, params: TypeRef, results: TypeRef): ExpressionRef;
        ...
        addEvent(name: string, attribute: number, params: TypeRef, results: TypeRef): EventRef;
        ...
        addEventImport(internalName: string, externalModuleName: string, externalBaseName: string, attribute: number, params: TypeRef, results: TypeRef): void;
        ...
        optimize(optimizeLevel: number, shrinkLevel: number, debugInfo?: boolean): void;
        validate(): boolean;
        interpret(): void;
...
declare module "assemblyscript/src/ast" {
    ...
    export enum NodeKind {
        ...
        CLASSDECLARATION = 50,
        ENUMDECLARATION = 51,
        ENUMVALUEDECLARATION = 52,
        FIELDDECLARATION = 53,
        FUNCTIONDECLARATION = 54,
        IMPORTDECLARATION = 55,
        INTERFACEDECLARATION = 56,
...
declare module "assemblyscript/src/passes/ministack" {
    /**
     ...
     */
    import { Pass } from "assemblyscript/src/passes/pass";
    import { ExportRef, Module } from "assemblyscript/src/module";
    import { Program } from "assemblyscript/src/program";
...
declare module "assemblyscript/src/glue/binaryen" {
    /**
    ...
    export function _BinaryenTry(module: ModuleRef, name: StringRef, bodyExpr: ExpressionRef, catchEvents: ArrayRef<StringRef>, numCatchEvents: Index, catchBodies: ArrayRef<ExpressionRef>, numCatchBodies: Index, delegateTarget: StringRef): ExpressionRef;
    ...
    export function _BinaryenTryGetNumCatchEvents(expr: ExpressionRef): Index;
    export function _BinaryenTryGetNumCatchBodies(expr: ExpressionRef): Index;
    export function _BinaryenTryGetCatchEventAt(expr: ExpressionRef, index: Index): StringRef;
    export function _BinaryenTrySetCatchEventAt(expr: ExpressionRef, index: Index, catchEvent: StringRef): void;
    export function _BinaryenTryAppendCatchEvent(expr: ExpressionRef, catchEvent: StringRef): Index;
    export function _BinaryenTryInsertCatchEventAt(expr: ExpressionRef, index: Index, catchEvent: StringRef): void;
    export function _BinaryenTryRemoveCatchEventAt(expr: ExpressionRef, index: Index): StringRef;
    ...
    export function _BinaryenThrow(module: ModuleRef, eventName: StringRef, operands: ArrayRef<ExpressionRef>, numOperands: Index): ExpressionRef;
    export function _BinaryenThrowGetEvent(expr: ExpressionRef): StringRef;
    export function _BinaryenThrowSetEvent(expr: ExpressionRef, eventName: StringRef): void;
    ...
    export function _BinaryenAddEventImport(module: ModuleRef, internalName: StringRef, externalModuleName: StringRef, externalBaseName: StringRef, attribute: number, params: TypeRef, results: TypeRef): void;
    ...
    export function _BinaryenAddEventExport(module: ModuleRef, internalName: StringRef, externalName: StringRef): ExportRef;
    ...
    export function _BinaryenAddEvent(module: ModuleRef, name: StringRef, attribute: number, params: TypeRef, results: TypeRef): EventRef;
    export function _BinaryenGetEvent(module: ModuleRef, name: StringRef): EventRef;
    export function _BinaryenRemoveEvent(module: ModuleRef, name: StringRef): void;
    export function _BinaryenEventGetName(event: EventRef): StringRef;
    export function _BinaryenEventGetAttribute(event: EventRef): number;
    export function _BinaryenEventGetParams(event: EventRef): TypeRef;
    export function _BinaryenEventGetResults(event: EventRef): TypeRef;
    export function _BinaryenAddTable(module: ModuleRef, name: StringRef, initial: Index, maximum: Index): TableRef;
    ...
    export function _BinaryenModuleAllocateAndWrite(out: ArrayRef<number>, module: ModuleRef, sourceMapUrl: StringRef): void;
    ...
    export function _BinaryenExpressionGetSideEffects(expr: ExpressionRef, features: FeatureFlags): SideEffects;
