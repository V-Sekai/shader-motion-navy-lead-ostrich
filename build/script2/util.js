...
export function resizeCanvas(gl) {
	...
	const canvasWidth  = Math.round(window.devicePixelRatio * gl.canvas.clientWidth);
	const canvasHeight = Math.round(window.devicePixelRatio * gl.canvas.clientHeight);
